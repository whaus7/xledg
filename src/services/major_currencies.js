const MAJOR_CURRENCIES = [
   { value: 'XRP', label: 'XRP', icon: '/icons/xrp.png' },
   { value: 'BTC', label: 'Bitcoin', icon: '/icons/bitcoin.png' },
   { value: 'BCH', label: 'Bitcoin Cash', icon: '/icons/bitcoin-cash.png' },
...
export default MAJOR_CURRENCIES;
